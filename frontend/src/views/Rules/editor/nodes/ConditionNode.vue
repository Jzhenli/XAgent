...
.rule-node:hover {
  ...
  box-shadow: 0 8px 28px rgba(0,0,0,0.25), 0 0 10px var(--node-condition-glow), inset 0 1px 0 rgba(255,255,255,0.25);
}
.rule-node.selected,
:deep(.vue-flow__node.selected) .rule-node {
  box-shadow: 0 0 0 2px var(--node-condition-glow), 0 6px 20px rgba(0, 0, 0, 0.3);
}
.node-glow {
