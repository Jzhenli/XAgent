 ...
 */
export declare function cubicProjectPoint(x0: number, y0: number, x1: number, y1: number, x2: number, y2: number, x3: number, y3: number, x: number, y: number, out: VectorArray | null): number;
/**
 * 计算三次贝塞尔曲线长度
 */
 ...
 * @return {number}
 */
export declare function quadraticProjectPoint(x0: number, y0: number, x1: number, y1: number, x2: number, y2: number, x: number, y: number, out: VectorArray | null): number;
/**
 * 计算二次贝塞尔曲线长度
 */
